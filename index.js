document.addEventListener("DOMContentLoaded", () => {
  ...
  //The response is then converted to a JSON
  .then(res => res.json())
  .then(data => {
  // console.log(data)
  const firstMovie = data[0]
  // console.log(firstMovie)
  //get references to several elements on the page and updates their properties using data from the firstMovie object
  ...
  //adding event listener that listens for a click event
  ...
  // fetch function to perse Tickets sold on the server
